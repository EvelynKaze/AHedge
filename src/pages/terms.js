...
const Terms = () => {
  return (
    <div className='text-center w-2/4 m-auto'>
      <h1 className='font-bold text-xl uppercase'>Terms & Conditions</h1>
      <p className='font-light'>
        The Terms & Conditions relates to how we collect, use, share and secure the personal information that you may supply to us. It also describes your choices regarding use, access and correction of your personal information.
          ...
          This Terms & Conditions governs the manner in which your personal information will be dealt with. Assetshedge is the entity collecting and holding your personal information in accordance with this Terms & Conditions. We reserve the right, at our discretion, to modify or remove portions of this Terms & Conditions at any time.

          Assetshedge is responsible for the processing of personal data that it receives under the Estonia laws, and other applicable international laws.

          Please take a moment to read this Terms & Conditions carefully. If you have any questions about this Terms & Conditions, please contact us at support@assetshedge.com. You should review this Terms & Conditions periodically so that you are updated on any changes.

          Use of Website
          By using this website, you agree to the Terms & Conditions of Assetsgedge which is set out on this website page. This Terms & Conditions is in addition to any other terms and conditions applicable to the website. This website may contain links to other websites not operated or controlled by us, and we do not make any representations about such third-party websites.
          ...
          <ul>
            <li>Users and potential users.</li>
            <li>Business associates and potential business associates, and their employees and contractors (where applicable).</li>
            <li>Individuals we deal with in the course of providing services to our users.</li>
            <li>Suppliers and their employees and contractors.</li>
            <li>Employees, prospective employees and contractors, and other people who come into contact with us.</li>
          </ul>
          ...
          Assetshedge Customers complete a verification procedure (they must provide an identification document issued by the state: passport or an ID card).Assetshedge reserves the right to collect Customers&quot; identification information for AML Policy purposes. This information is processed and stored strictly in accordance with Assetshedge Terms & Conditions.

          Assetshedge may also request a second Customer identification document: a bank statement or utility bill no older than 3 months, which includes the Customer&quot;s full name and current address.
          ...
          <ul>
            ...
            <li>to provide you with our services and any other services you request;</li>
            <li>to market our services to you;</li>
            <li>to engage with third parties on your behalf;</li>
            <li>to communicate with you;</li>
            <li>to help us manage and enhance our services; and</li>
