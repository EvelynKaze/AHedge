  ...
  return (
    <div className="bg-white">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-14 sm:py-14 lg:py-10">
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                Join us
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
                A trader career with Wallethedge puts you at the forefront of innovation in the digital age. Work with the brightest minds in business to imagine and invent the future.
            </p>
